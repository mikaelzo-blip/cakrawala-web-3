  ...
  return (
    <div className="py-12 md:py-20 bg-[#F8FAFC] min-h-screen">
      <Container>
        {/* Header Indeks */}
        <SectionHeading
          badge="Dokumentasi Pekerjaan Teknis"
          title="Indeks Portofolio Studi Kasus CBL"
          description="Eksplorasi rekam jejak pengerjaan teknis berdasarkan divisi spesialisasi. Pilih kategori di bawah ini untuk menyaring hasil."
          as="h1"
        />
